...
namespace RFIDAPI.Helper
{
    public class FileHelpers
    {
        ...
        public static async Task<byte[]> ProcessStreamedFile(IFormFile file, ModelStateDictionary modelState, string[] permittedExtensions, long sizeLimit, int minimumSize)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
        ...
        public static async Task<byte[]> ProcessStreamedFileOld(MultipartSection section, ContentDispositionHeaderValue contentDisposition, ModelStateDictionary modelState, string[] permittedExtensions, long sizeLimit, int minimumSize)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
